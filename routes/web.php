...
Route::middleware('auth')->group(function () {
    ...
    Route::patch(
        '/requests/{request}/applications/{application}/status',
        [RequestController::class, 'updateApplicationStatus']
    ...
    Route::get('/spotify/connect',  [SpotifyController::class, 'redirectToSpotify'])
         ->name('spotify.connect');
    Route::get('/spotify/callback', [SpotifyController::class, 'handleCallback'])
         ->name('spotify.callback');
    Route::get('/spotify/playlists', [SpotifyController::class, 'showPlaylists'])
